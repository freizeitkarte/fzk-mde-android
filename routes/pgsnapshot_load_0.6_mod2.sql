...
SET client_encoding TO 'UTF8'; --SBR
...
-- SBR: This index needs hours for creating and it is not needed for route relation calculation.
...
/* SBR will be done in the next step
VACUUM ANALYZE;
*/
